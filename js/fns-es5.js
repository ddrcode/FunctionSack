/**
 * Based on ddr-ecma5 library (made by author of FunctionSack)
 * Uses ddr-ecma5 version: 1.2.1 (slightly adopted for the needs of FunctionSack)
 * 
 * Supported features:<ul>
 * <li>{@link Function#bind}</li>
 * <li>{@link String#trim}</li>
 * <li>{@link Array.isArray}</li>
 * <li>{@link Array#indexOf}</li>
 * <li>{@link Array#lastIndexOf}</li>
 * <li>{@link Array#every}</li>
 * <li>{@link Array#some}</li>
 * <li>{@link Array#forEach}</li>
 * <li>{@link Array#map}</li>
 * <li>{@link Array#filter}</li>
 * <li>{@link Array#reduce}</li>
 * <li>{@link Array#reduceRight}</li>
 * <li>{@link Date.now}</li>
 * <li>{@link Date#toISOString}</li>
 * <li>{@link Date#toJSON}</li>
 * <li>{@link Object.getPrototypeOf}</li>
 * <li>{@link Object.create}</li>
 * <li>{@link Object.isSealed}</li>
 * <li>{@link Object.isFrozen}</li>
 * <li>{@link Object.isExtensible}</li>
 * <li>{@link Object.getOwnPropertyDescriptor}</li>
 * <li>{@link Object.defineProperty}</li>
 * <li>{@link Object.defineProperties}</li>
 * <li>{@link Object.keys}</li>
 * <li>{@link Object.getOwnPropertyNames}</li>
 * </ul>
 * 
 * @name %(namespace)s.es5 
 * @namespace   Provides ECMSCript 5 methods for ECMAScript 3 environments.
 * @type {Object}
 * @static
 */
(function(){
